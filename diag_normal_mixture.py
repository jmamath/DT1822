...
class MixtureOfDiagNormals(TorchDistribution):
    ...
    def expand(self, batch_shape, _instance=None):
        ...
        new.log_probs = self.log_probs.expand(batch_shape + self.probs.shape[-1:])
    ...
    def log_prob(self, value):
        ...
        coord_scale_prod_log = self.coord_scale.log().sum(-1)  # B K
        result = self.log_probs + (-eps_sqr + eps_sqr_min.unsqueeze(-1)) - coord_scale_prod_log  # L B K
